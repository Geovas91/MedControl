...
const sensitiveKeyPattern = /password|token|secret|authorization|cookie|medicalNote|diagnosis|patientName|email|phone|hash|signature|pdfBytes|consentText|storagePath|comment|reviewText/i;

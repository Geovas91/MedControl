...
with consent_catalog (system_key, name, content) as (
  values
    ('consent_general_care_v1', 'Consentimiento general de atención', 'Descripción de la atención:\n\nFinalidad:\n\nBeneficios esperados:\n\nRiesgos generales:\n\nAlternativas y posibilidad de hacer preguntas:\n\nAceptación voluntaria y revocación cuando corresponda:\n\nNombre y firma del firmante:\n\nFecha:'),
    ('consent_sensitive_data_v1', 'Aviso y autorización para tratamiento de datos personales sensibles', 'Descripción y finalidad del tratamiento de datos:\n\nInformación que puede tratarse:\n\nMedidas administrativas aplicables:\n\nPosibilidad de hacer preguntas:\n\nAceptación voluntaria y revocación cuando corresponda:\n\nNombre y firma del firmante:\n\nFecha:'),
    ('consent_medical_procedure_v1', 'Consentimiento para procedimiento médico', 'Procedimiento: [Nombre del procedimiento]\n\nDescripción: [Descripción]\n\nBeneficios esperados: [Beneficios esperados]\n\nRiesgos relevantes: [Riesgos relevantes]\n\nAlternativas: [Alternativas]\n\nPosibilidad de hacer preguntas y aceptación voluntaria:\n\nNombre y firma del firmante:\n\nFecha:'),
    ('consent_minor_procedure_v1', 'Consentimiento para procedimiento menor', 'Procedimiento: [Nombre del procedimiento]\n\nDescripción: [Descripción]\n\nBeneficios esperados: [Beneficios esperados]\n\nRiesgos relevantes: [Riesgos relevantes]\n\nAlternativas: [Alternativas]\n\nPosibilidad de hacer preguntas y aceptación voluntaria:\n\nNombre y firma del firmante:\n\nFecha:'),
    ('consent_clinical_photos_v1', 'Consentimiento para toma y uso de fotografías clínicas', 'Descripción de las fotografías clínicas:\n\nFinalidad y alcance del uso:\n\nRiesgos generales de privacidad:\n\nAlternativas y posibilidad de hacer preguntas:\n\nAceptación voluntaria y revocación cuando corresponda:\n\nNombre y firma del firmante:\n\nFecha:'),
    ('consent_teleconsultation_v1', 'Consentimiento para teleconsulta', 'Descripción de la teleconsulta:\n\nFinalidad y limitaciones del medio remoto:\n\nRiesgos generales de privacidad y comunicación:\n\nAlternativas y posibilidad de hacer preguntas:\n\nAceptación voluntaria:\n\nNombre y firma del firmante:\n\nFecha:'),
    ('consent_representative_v1', 'Autorización de representante o tutor', 'Descripción de la representación o tutela:\n\nFinalidad de la autorización:\n\nAlcance, responsabilidades y posibilidad de hacer preguntas:\n\nAceptación voluntaria y revocación cuando corresponda:\n\nNombre y firma del representante o tutor:\n\nFecha:'),
    ('consent_informed_refusal_v1', 'Negativa informada de atención o tratamiento', 'Descripción de la atención o tratamiento propuesto:\n\nInformación revisada, beneficios esperados y riesgos generales de rechazarlo:\n\nAlternativas y posibilidad de hacer preguntas:\n\nManifestación voluntaria de negativa:\n\nNombre y firma del firmante:\n\nFecha:')
)
insert into public.medical_note_templates as target (
  clinic_id, name, specialty, description, template_schema, is_system_template,
  system_key, is_active, template_kind, created_by

...
La entrega de invitaciones registra únicamente `component=invitation_email`, operación, estado técnico seguro, `invitation_id`, `clinic_id` y proveedor. Nunca registra destinatario, token, hash, URL, HTML, texto, API key ni respuesta completa de Resend.

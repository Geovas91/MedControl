  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-10 sm:px-6">
      <section className="mx-auto max-w-2xl rounded-lg border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <p className="text-sm font-semibold uppercase tracking-wide text-clinic">MedControl</p>
        ...
        <p className="mt-4 leading-7 text-slate-600">
          MedControl se encuentra en staging controlado. No uses este flujo con pacientes reales ni compartas enlaces de

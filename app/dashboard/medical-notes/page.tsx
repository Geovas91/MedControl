...
export default function MedicalNotesPage() {
  return (
    <>
      <PageHeader
        title="Notas médicas"
        description="Espacio demo de documentación clínica con plantillas por especialidad."
        action={{ label: "Nueva nota", href: "/dashboard/medical-notes/new", icon: <Plus className="h-4 w-4" /> }}
      />
